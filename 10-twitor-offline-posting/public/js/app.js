...
postBtn.on('click', function () {
    ...
    // Creo un objeto con la informacion de mi mensaje
    var data = {
        mensaje: mensaje,
        user: usuario
    };

    // Genero la peticion post con mi mensaje
    fetch('/api', {
        method: 'POST',
        headers: {
        ...
        .then(res => res.json()) //obtengo un json de mi respuesta
        .then(res => console.log('app.js: ', res))//puedo imprimirla
...
// Obtener mensajes del servidor // COnsumir servicio REST
